...
public class Messages {
  ...
  public static final String CONFIG_PANEL_BORDER_TITLE = "Config Panel";
  ...
  public static final String DATABASE_FILE_LOCATION_TOOLTIP_TEXT = "The location of the database file on the file system.";

  public static final String EXIT_MENU_ITEM_TEXT = "Exit";

  public static final String FATAL_EXCEPTION_MESSAGE_TITLE = "Unexpected System Error";
  ...
  public static final String INVALID_IP_MESSAGE_TEXT = "The database file location field cannot be blank.";
