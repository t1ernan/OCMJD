 ...
 * exist,the magic cookie value of the file selected does not match the expected value of the
 * database file or the database file could not be read for some IO related reason.
 */
