package suncertify.test.util;

import static suncertify.test.util.Constants.DEFAULT_DB_LOCATION_SERVER;
import static suncertify.test.util.Constants.DEFAULT_DB_LOCATION_STANDALONE;
