...
/**
 * The class DuplicateKeyException is thrown when attempting to add a new entry to the database if
 * the database already contains an entry, which hasn't been marked as deleted, with the same
 * primary key.
 */
